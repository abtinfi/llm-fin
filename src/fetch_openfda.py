...
def main():
    ...
    ap.add_argument("--api_key", default=None,
                    help="optional openFDA key; prefer the OPENFDA_API_KEY "
                         "environment variable so it stays out of shell history")
    ...
    if not api_key:
        print("no API key set -- proceeding with the anonymous rate limit",
              file=sys.stderr)
