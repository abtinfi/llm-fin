# UQ coverage report -- `heldout_mimic3b`, variant `nsai_uq_cl`

Signal: **`decision_entropy`**. Target error rate on retained items: alpha = 0.1. n = 36542.
...
|---|---|---|---|---|
| warfarin_inr4 | 36542 | 1.000 | 1.000 | 0.000 |

**by `label`**

| value | n | coverage | selective accuracy | violation rate |
|---|---|---|---|---|
| SAFE | 24371 | 1.000 | 1.000 | 0.000 |
| UNSAFE | 12171 | 1.000 | 1.000 | 0.000 |

**by `gate_fired`**

| value | n | coverage | selective accuracy | violation rate |
|---|---|---|---|---|
| True | 36542 | 1.000 | 1.000 | 0.000 |
