...
|---|---|---|---|
| frozen tau (calibration split) | 0.684 | 0.039 | 0.10 |
...
|---|---|---|---|---|
| metformin_egfr30 | 36724 | 0.276 | 1.000 | 0.000 |
| metformin_egfr45 | 64714 | 0.598 | 0.886 | 0.187 |
...
| value | n | coverage | selective accuracy | violation rate |
|---|---|---|---|---|
| SAFE | 112844 | 0.785 | 1.000 | 0.000 |
| UNSAFE | 53420 | 0.469 | 0.824 | 0.082 |

**by `gate_fired`**

| value | n | coverage | selective accuracy | violation rate |
|---|---|---|---|---|
| False | 101438 | 0.481 | 0.910 | 0.124 |
| True | 64826 | 1.000 | 1.000 | 0.000 |

Widest coverage gap between subgroups of n>=5: **0.724** (min 0.276, max 1.000). Marginal coverage is 0.684.
