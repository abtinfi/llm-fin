...
UQ engine defers on **`logit_margin`**  (decision-level signal; see `results/bigbench_uq.md`)
...
|---|---|---|---|---|
| base→rag | 18 | 12 | 0.3616 | 0.7232 |
| base→nsai | 35 | 5 | 1.383e-06 | 4.148e-06 |
| base→nsai_uq | 26 | 22 | 0.6655 | 0.7232 |
| base→sym | 26 | 0 | 2.98e-08 | 1.192e-07 |
| base→uq | 0 | 50 | 1.776e-15 | 8.882e-15 |
