...
- [x] ~~**MIMIC-IV** (§4.6).~~ Built from the full credentialed v3.1
      ...
      is kept beside it. Evaluations are running under the supervisor; the
      numbers go in PAPER.md when they land. Superseded text follows:
